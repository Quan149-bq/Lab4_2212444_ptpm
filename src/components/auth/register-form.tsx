...
export function RegisterForm() {
 ...
 if (data.user) {
 // Đăng ký thành công
 router.push('/login?message=Đăng ký thành công! Vui lòng kiểmtra email để xác nhận.')
 }
 } catch (err) {
 ...
 <div>
 <label htmlFor="displayName" className="block text-sm fontmedium text-gray-700">
 Tên hiển thị
 </label>
 <input
 id="displayName"
...
focus:border-blue-500"
 placeholder="••••••••"
 />
 <p className="mt-1 text-xs text-gray-500">Tối thiểu 6 ký
tự</p>
 </div>
 </div>
 <button
